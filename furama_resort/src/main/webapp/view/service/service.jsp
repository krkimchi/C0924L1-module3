...
<div class="wrapper">
    <h2><i class="bx bx-home-alt icon"></i>Add New Service</h2>
    ...
    <form id="add-form" action="${pageContext.request.contextPath}/service" method="post" class="add-form active">
        ...
        <div class="form-grid">
            ...
            <div class="form-item">
                ...
                <input type="number" id="service_area" name="service_area" min="0">
            </div>
            <div class="form-item">
                <label for="service_cost">Service Cost:</label>
                <input type="number" id="service_cost" name="service_cost" step="0.01" min="0" required>
            </div>
            <div class="form-item">
            ...
            <div id="villa_fields" class="form-item hidden">
                ...
                <input type="text" id="standard_room_villa" name="standard_room">
                <label for="description_other_convenience_villa">Other Convenience:</label>
                <input type="text" id="description_other_convenience_villa" name="description_other_convenience">
                <label for="pool_area">Pool Area (m²):</label>
                <input type="number" id="pool_area" name="pool_area" step="0.01" min="0">
                <label for="number_of_floors_villa">Number of Floors:</label>
                <input type="number" id="number_of_floors_villa" name="number_of_floors" min="1">
            </div>

            <div id="house_fields" class="form-item hidden">
                <label for="standard_room_house">Standard Room:</label>
                <input type="text" id="standard_room_house" name="standard_room">
                <label for="description_other_convenience_house">Other Convenience:</label>
                <input type="text" id="description_other_convenience_house" name="description_other_convenience">
                <label for="number_of_floors_house">Number of Floors:</label>
                <input type="number" id="number_of_floors_house" name="number_of_floors" min="1">
            </div>
