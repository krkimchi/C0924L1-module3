...
import com.codegym.ss12_jdbc.model.User;
...
public class UserService implements IUserService {
    ...
    private static final String SELECT_USERS_SORTED_BY_NAME = "select * from users order by name asc;";
    ...
    public boolean deleteUser(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection connection = DatabaseConnection.getConnection(); PreparedStatement statement = connection.prepareStatement(DELETE_USERS_SQL);) {
