package com.codegym.ss12_jdbc.controller;

import com.codegym.ss12_jdbc.model.User;
import com.codegym.ss12_jdbc.service.UserService;
...
public class UserServlet extends HttpServlet {
    ...
    private void searchUserByCountry(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("searchQuery", country);
    ...
    private void sortUsersByName(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, ServletException, IOException {
        List<User> sortedUsers = userService.sortUsersByName();
